...
rmv7.data.com <- mergeCMs(get_cm(zoom(porec_rmv_mapping_list[[1]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[2]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[3]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[4]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[5]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[6]],res=gwas_locus_size), exclude = rmv7_pv_locus)
                     )
...
rmv7.hic.data.com <- mergeCMs(#get_cm(zoom(hic_rmv_mapping_list[[1]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[2]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[3]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[4]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[5]],res=gwas_locus_size), exclude = rmv7_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[6]],res=gwas_locus_size), exclude = rmv7_pv_locus)
                     )
...
rmv8.data.com <- mergeCMs(get_cm(zoom(porec_rmv_mapping_list[[7]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[8]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[9]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[10]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[11]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(porec_rmv_mapping_list[[12]],res=gwas_locus_size), exclude = rmv8_pv_locus)
                     )
...
rmv8.hic.data.com <- mergeCMs(get_cm(zoom(hic_rmv_mapping_list[[7]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[8]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[9]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[10]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[11]],res=gwas_locus_size), exclude = rmv8_pv_locus),
                         get_cm(zoom(hic_rmv_mapping_list[[12]],res=gwas_locus_size), exclude = rmv8_pv_locus)
                     )
...
prci_contacts_df <-
  dplyr::bind_rows(hires_interactions_bedpe_df %>%
              dplyr::left_join(prci_df, by = c("Genotype")) %>% 
...
fit_glmmTMB_structure <- function(input_df) {
  ...
  contact_density_model <-
    glmmTMB::glmmTMB(
      ContactFrequency ~ `Distance classification` + (1-Distance_from_origin) + mean_GC + mean_MluCI + mean_NlaIII + Classification*Variant + (Variant|Position) + (1|Replicate),# + (1|Position:Variant),
      data = input_df %>%
...
correlation_output_df <-
  ...
  dplyr::mutate(Separation = dplyr::if_else(Method == "Hi-C",Interval*5000,Interval*5000))
...
rna_induction_df <-
  process_qpcr_input_file("./qPCR/induction_MMC_RMV8_sugar_3replicates.csv",
